...
<img src="../_Additional_Materials/Images/Lab_00_00.JPG" width="600" alt="Клонирование репозитория на компьютер.">
...
<img src="../_Additional_Materials/Images/Lab_00_02.JPG" width="600" alt="Клонирование репозитория на компьютер.">

4. Запустил программу через терминал и сделал скриншот результата выполнения.

<img src="../_Additional_Materials/Images/Lab_00_03.JPG" width="600" alt="Клонирование репозитория на компьютер.">
