...
print(
    secret_message[0][3],               # 4-я буква
    secret_message[1][9:13],            # буквы с 10 по 13, включительно
    secret_message[2][5:15:2],          # буквы с 6 по 15, включительно, через одну
    secret_message[3][7:13][::-1],      # буквы с 8 по 13, включительно, в обратном порядке
    secret_message[4][16:21][::-1],     # буквы с 17 по 21, включительно, в обратном порядке
    sep = ' '
)