...
Реализует выбор и запуск одного из NUMBER_OF_VARIANTS вариантов задания.
"""
...
def show_menu() -> None:
    ...
    Функция реализует отображение меню варианта задания.
    """
...
def main() -> None:
    ...
    Организует цикл выбора варианта, обработку выбора пользователя, 
    очистку экрана, обработку ошибок и возврат в главное меню.
    """
